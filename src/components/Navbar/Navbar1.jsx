        ...
        <>
            <nav className='bg-gray-900 text-white p-4'>
                <ul className='flex flex-wrap items-center justify-center gap-8'>
                    <li className='inline-flex items-center text-white rounded-2xl border border-gray-400 cursor-pointer px-7 py-2 bg-[#432323] transition-colors duration-300 ease-out hover:text-gray-900 hover:bg-[#C2A68C]'>Start</li>
